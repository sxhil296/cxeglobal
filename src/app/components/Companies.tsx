  ...
  return (
    <div className="w-full bg-white flex flex-col justify-center items-center sm:py-20 py-10 mb-8">
      <div className="max-w-[1280px] mx-auto text-center px-4">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold py-8">Our Business Partners</h1>
        ...
        {/* Company Logos */}
        <div className="flex flex-wrap justify-center gap-7  sm:mb-6">
          {companies.map((company, index) => (
            <div
              key={index}
              className="border border-black  p-4 sm:p-6 flex items-center justify-center hover:shadow-lg"
